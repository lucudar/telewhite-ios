...
// The detection rules themselves live in TelegramCore (TelewhiteLanguageDetection.swift),
// because the per-message translate button needs the same verdict and cannot see this module.
