...
public final class ChatControllerImpl: TelegramBaseController, ChatController, GalleryHiddenMediaTarget, UIDropInteractionDelegate {    
    ...
    private var telewhiteDisablesReadHistory: Bool {
        return self.telewhiteModsSettings.ghostMode || self.telewhiteModsSettings.hideReadReceipts || self.telewhiteModsSettings.isGhostEnabled(for: self.chatLocation.peerId)
    }
    private var telewhiteDisablesActivity: Bool {
        return self.telewhiteModsSettings.ghostMode || self.telewhiteModsSettings.hideTypingStatus || self.telewhiteModsSettings.isGhostEnabled(for: self.chatLocation.peerId)
    }
